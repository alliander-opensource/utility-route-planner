...
class TestHexagonEdgeGenerator:
    ...
    def test_generate_edges_with_previous_blocks(self, hexagonal_grid: pl.DataFrame, block: pl.DataFrame):
        ...
        previous_nodes_current_row = pl.DataFrame(
            data=[
                [9, 126, -29163, 79694],
                [10, 126, -29163, 79693],
                [11, 76, -29165, 79693],
        ...
        relevant_previous_row_nodes = pl.DataFrame(
            data=[
                [14, 76, -29163, 79696],
                [15, 76, -29163, 79697],
                [16, 76, -29163, 79695],
        ...
        nodes_to_check = pl.concat([block, previous_nodes_current_row, relevant_previous_row_nodes])
